...
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/AGr.jpg')
START_IMG = environ.get('START_IMG', 'https://envs.sh/AGr.jpg')
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002037384930'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002037384930'))
